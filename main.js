// --- REGISTRE GSAP ---
        ...
        // Applique les styles de position au container
        ...
        window.addEventListener('load', () => {
            ...
            canImg.addEventListener('animationend', () => {
        ...
        function setupScrollAnimations() {
            ...
            // On anime left, top, width, height directement sur le container
            ...
            // Hero → Section 2
            tl.to(canContainer, {
                left: pos.section2.left, top: pos.section2.top,
                width: pos.section2.w, height: pos.section2.h,
                ease: 'power1.inOut'
            }, 0);
            tl.to(canImg, {
                rotation: pos.section2.rot, scale: pos.section2.scale,
                ease: 'power1.inOut'
            }, 0);

            // Section 2 → Section 3
            tl.to(canContainer, {
                left: pos.section3.left, top: pos.section3.top,
                width: pos.section3.w, height: pos.section3.h,
                ease: 'power1.inOut'
            }, 1);
            tl.to(canImg, {
                rotation: pos.section3.rot, scale: pos.section3.scale,
                ease: 'power1.inOut'
            }, 1);

            // Section 3 → Section 4 (Stats zoom)
            tl.to(canContainer, {
                left: pos.section4.left, top: pos.section4.top,
                width: pos.section4.w, height: pos.section4.h,
                ease: 'power1.inOut'
            }, 2);
            tl.to(canImg, {
                rotation: pos.section4.rot, scale: pos.section4.scale,
                ease: 'power1.inOut'
            }, 2);

            // Section 4 → Section 5 (CTA)
            tl.to(canContainer, {
                left: pos.section5.left, top: pos.section5.top,
                width: pos.section5.w, height: pos.section5.h,
                ease: 'power1.inOut'
            }, 3);
            tl.to(canImg, {
                rotation: pos.section5.rot, scale: pos.section5.scale,
                ease: 'power1.inOut'
            }, 3);
        }
        ...
        function selectFlavor(flavor) {
            ...
            canImg.classList.remove('idle-float', 'spinning');
            void canImg.offsetWidth; // reflow force
            ...
            gsap.to(['#bg-orange', '#bg-grape', '#bg-lemon'], { opacity: 0, duration: 0.8 });
            gsap.to(`#bg-${flavor}`, { opacity: 1, duration: 0.8 });

            // E4. Variables CSS thème
            const themes = {
                orange: { primary: '#ff7c00', dark: '#e64a19', glow: 'rgba(255, 124, 0, 0.4)' },
                grape:  { primary: '#8e24aa', dark: '#4a148c', glow: 'rgba(142, 36, 170, 0.4)' },
                lemon:  { primary: '#afb42b', dark: '#689f38', glow: 'rgba(175, 180, 43, 0.4)' },
            };
        ...
        function transitionBubbleColors(flavor) {
            ...
            gsap.to(bubbleColorObj.c1, {
                r: tc.c1.r, g: tc.c1.g, b: tc.c1.b, duration: 0.8,
                onUpdate: () => {
            ...
            gsap.to(bubbleColorObj.c2, { r: tc.c2.r, g: tc.c2.g, b: tc.c2.b, duration: 0.8 });
        }
        ...
        class Bubble {
            ...
            reset(initial = false) {
                ...
                this.y = initial ? Math.random() * bubbleCanvas.height : bubbleCanvas.height + this.radius + 10;
            ...
            update() {
                ...
                if (this.y < -this.radius || this.x < -this.radius || this.x > bubbleCanvas.width + this.radius) {
                    this.reset(false);
                }
            }
            draw() {
                ...
                grad.addColorStop(0, bubbleColor2.replace('0.08', (this.opacity*1.6).toFixed(2)));
                ...
                bCtx.arc(this.x - this.radius*0.3, this.y - this.radius*0.3, this.radius*0.15, 0, Math.PI*2);
                bCtx.fill();
            }
        }
